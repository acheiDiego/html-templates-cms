...
{
    var table_body = $"<tbody id=\"meansure-tire-table\">\r\n        {row}\r\n      </tbody>";
...
void create_table()
{
    ...
    {
        table_row = table_row + $"<tr class=\"table-data-row\"> <td class=\"table-cell row-data\">{row.meansure}</td>  <td class=\"table-cell row-data\">{row.apply}</td> <td class=\"table-cell row-data\">{row.speedIndex}</td> <td class=\"table-cell row-data\">{row.chargeIndex}</td> <td class=\"table-cell row-data\">{row.presion}</td>  <td class=\"table-cell row-data\">{row.calibration}</td> </tr>";
    }
